...
class GraphQLEntityFetcher {
    constructor(entityName, onGetSelectFields, graphqlClient) {
        ...
        this.executeAsync = (operationName, query, variables) => this.graphqlClient.executeAsync(this.entityName, operationName, query, variables);
        this.sumAsync = (fields, sumFormula, query) => this.graphqlClient.sumAsync(this.entityName, fields, sumFormula, query);
